import"./main-CkMIK7XV.js";import{s}from"./supabase-DiR5dlJX.js";document.addEventListener("DOMContentLoaded",async()=>{const t=document.getElementById("ofertas-container"),r=document.getElementById("loading-ofertas");if(!(!t||!r))try{const{data:e,error:a}=await s.from("nuevaOferta").select("*").eq("estado","pendiente").order("id",{ascending:!1});if(a)throw a;if(r.style.display="none",!e||e.length===0){t.innerHTML=`
